...
async function measureMemory(name, fn) {
    await forceGC();
...
// ============================================================
async function benchmarkTokenMemory() {
    console.log('\n' + '='.repeat(80));
...
// ============================================================
async function benchmarkStackMemory() {
    console.log('\n' + '='.repeat(80));
...
// ============================================================
async function benchmarkSpaceMemory() {
    console.log('\n' + '='.repeat(80));
...
// ============================================================
async function benchmarkCRDTMemory() {
    console.log('\n' + '='.repeat(80));
...
// ============================================================
async function benchmarkEngineMemory() {
    console.log('\n' + '='.repeat(80));
...
// ============================================================
async function benchmarkRealWorldMemory() {
    console.log('\n' + '='.repeat(80));
