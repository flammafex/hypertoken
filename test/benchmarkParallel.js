 ...
 */
async function sequentialSimulations(numSims, turns, tokens) {
 ...
 */
async function parallelSimulations(numSims, turns, tokens) {
 ...
 */
async function sequentialMerge(docs) {
    const startTime = Date.now();
    const chronicle = new Chronicle();
 ...
 */
async function parallelMerge(docs) {
    const parallel = new ParallelOps();
    const startTime = Date.now();
