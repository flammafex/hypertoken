...
async function runTests() {
    ...
    try {
        ...
        const successRate = results.reduce((sum, r) => sum + r.metrics.successfulActions / r.metrics.totalActions, 0) / results.length;
    ...
    try {
        ...
        console.log(`   ✓ Variant A success rate: ${(comparison.comparison.avgSuccessRateA * 100).toFixed(2)}%`);
        console.log(`   ✓ Variant B success rate: ${(comparison.comparison.avgSuccessRateB * 100).toFixed(2)}%`);
        await parallel.shutdown();
