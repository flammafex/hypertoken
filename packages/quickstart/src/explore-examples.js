...
export async function exploreExamples() {
    ...
    const examples = [
        ...
        {
            title: '❌ Tic-Tac-Toe',
            description: 'Network multiplayer demo with P2P sync',
            path: 'examples/network-tictactoe',
            command: 'node server.js',
            features: [
                'Real P2P synchronization',
                'CRDT-based game state',
                'Simple relay server',
                'Multiple clients'
            ]
        },
        ...
        {
            title: '🔮 Tarot Reading',
            description: 'Divination with 8 traditional spreads',
            path: 'examples/tarot-reading',
            command: 'node tarot-cli.js',
            features: [
                '78-card Tarot deck',
                '8 traditional spreads',
...
async function showExampleDetails(example) {
    console.log();
